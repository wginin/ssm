...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<!-- 导航侧栏 -->
		<jsp:include page="aside-security.jsp"></jsp:include>
		<!-- 导航侧栏 /-->
		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
						...
						<table id="dataList"
							...
							<tbody>
								...
								<tr>
									...
									<td>
                                        <fmt:formatDate value="${product.departureTime}" pattern="yyyy-MM-dd" />
									...
									<td>
                                        <c:choose>
                                            <c:when test="${product.productStatus==0}">关闭</c:when>
                                            <c:otherwise>开启</c:otherwise>
                                        </c:choose>
                                    </td>
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="/product/list?page=1&size=5" aria-label="Previous">首页</a></li>
							<li><a href="/product/list?page=${pageInfo.pageCode-1}&size=5">上一页</a></li>
                            <c:forEach begin="1" end="${pageInfo.totalPage}" var="i">
                                <li><a href="/product/list?page=${i}&size=5">${i}</a></li>
                            </c:forEach>
							<li><a href="/product/list?page=${pageInfo.pageCode+1}&size=5">下一页</a></li>
							<li><a href="/product/list?page=${pageInfo.totalPage}&size=5" aria-label="Next">尾页</a></li>
						</ul>
					</div>
