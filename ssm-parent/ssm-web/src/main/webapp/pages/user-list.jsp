									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/one?id=${user.id }" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/role/modify?id=${user.id }" class="btn bg-olive btn-xs">添加角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<script>
							function formSubmit(who) {
								//url
								var url='/user/list?size='+who.value;
								//发送请求
								location.href=url;
                            }
						</script>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li><a href="/user/list?page=${pageInfo.lastPage}&size=${pageInfo.pageSize}" aria-label="Next">尾页</a></li>
							</ul>
						</div>
