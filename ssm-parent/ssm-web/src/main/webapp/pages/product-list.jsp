		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					...
					<script>
						//监控每页选项
						function formSubmit(who) {
							var url = '/product/list?size='+who.value;
							location.href=url;
                        }
					</script>
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="/product/list?size=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
							<li><a href="/product/list?page=${pageInfo.prePage}&size=${pageInfo.pageSize}">上一页</a></li>
